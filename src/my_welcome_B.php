...
<html lang="en" class="h-100">
	...
	<body class="text-center text-white bg-dark">
		<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
			...
			<main class="px-3">
				<div id="Ventana_A">			
					<br><p><a href="my_product_register.php" class="btn btn-info">Añadir Producto</a></p><br>
			
					<form action="" method="POST">
						<div class="row row-cols-1 row-cols-sm-2 row-cols-md-1 g-3">
							<?php
								$PC = $tienda->mostrar_cantidad_productos();
								for($i=0;$i<$PC;$i++){
									echo "".
										"<div class='col'>".
											"<div class='card shadow-sm text-dark'>".
												"<div class='card-body'>";
													echo $tienda->mostrar_producto($i)->mostrar_informacion()."<br>";
													echo "".
														"<button type='submit' name='p_edit' value='$i'".
				...
				<?php
					if (isset($_POST["p_edit"])){
						$_SESSION['aux_2'] = $_POST["p_edit"];
						echo "
							<script>
								$.ajax({
									type: 'GET',
									url: 'my_product_edit.php',
