...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
  ...
  <main class="px-3">
    <h1>BIENVENIDO</h1>
    <p class="lead">Esto es un super creador de inventarios, ideal para gente que quiere optimizar el orden en su negocio de manera simple y eficaz.</p>
    <p class="lead">
      <a href="my_register.php" class="btn btn-lg btn-secondary fw-bold border-white bg-white">¡Crea tu inventario ahora!</a>
    </p>
  </main>
